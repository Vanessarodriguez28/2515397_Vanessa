...
function numero(a,b,c) {
  if (b < a && b < c) { console.log ('el segundo numero es el menor',b)}
  else if (a < b && a < c) { console.log ('el primer numero es menor',a)}
  else {console.log ('el tercer numero es menor') }}
numero(4,2,3)


//FUNCION FLECHA PUNTO 1 CONDICIONAL 

const numero = (a,b,c) => { if (b < a && b < c) {console.log ('el segundo numero es el menor',b)}else if (a < b && a < c) {console.log ('el primer numero es menor',a)}else {
...
si hay dos iguales o si son los tres distintos */
 ...
 function digitos (a,b,c){
    if (a==b && a==c){console.log ('Los digitos son iguales',[a,b,c])}
    else if (b==a && b==c){console.log ('Los digitos son iguales',[a,b,c])}
    else if (c==a && c==b){console.log ('Los digitos son iguales')}
    else if (a!=b && a!=c){console.log ('Los digitos son diferentes',[a,b,c])}
    else if (b!=a && b!=c){console.log ('Los digitos son diferentes',[a,b,c])}
    else if (c!=a && c!=b){console.log ('Los digitos son diferentes',[a,b,c])}}
digitos (2,2,2) ;

//FUNCION FLECHA PUNTO 2 CONDICIONAL

const digitos = (a,b,c) => { if (a==b && a==c){console.log ('Los digitos son iguales',[a,b,c])}else if (b==a && b==c){console.log ('Los digitos son iguales',[a,b,c])}else if (c==a && c==b){console.log ('Los digitos son iguales')}else if (a!=b && a!=c){console.log ('Los digitos son diferentes',[a,b,c])}
else if (b!=a && b!=c){console.log ('Los digitos son diferentes',[a,b,c])}else if (c!=a && c!=b){console.log ('Los digitos son diferentes',[a,b,c])}}
digitos (2,1,3);
 ...
 function numero (n){ 
    if(n<10){console.log("tiene 1 cifra"); }  
    else if(n<100){console.log("tiene 2 cifras"); }    
    else if(n<1000){console.log("tiene 3 cifras");}
    else if(n<10000){console.log("tiene 4 cifras");}}
    numero (245);
...
const nota = (n) => {if (n==10){ console.log ('Su nota es excelente')} else if (n>8){ console.log ('Su nota es superior')}
else if (n > 6) { console.log ('su nota es regular')}else if (n >4) { console.log ('su nota mala')}else {console.log ('su nota es baja')}} 
nota(8);
...
const numero = (n) => {if (n<=0) {console.log(" Mes no valido") } else if (n<=31){console.log("PERTENECE A ENERO")} else if (n<59){console.log("PERTENECE A FEBRERO")} else if (n<90){console.log("PERTENECE A MARZO")} else if (n<120){console.log("PERTENECE A ABRIL")} else if(n<151){console.log("PERTENECE A MAYO")} else if(n<181){ console.log("PERTENECE A JUNIO")} else if(n<212){ console.log("PERTENECE A JULIO")
...
function n_perfectos (n,c,p){
    ...
    const n_perfectos =(n,c,p) =>{var n = 1,c = 0,p = 0
        console.log
        for (i = 1 ; i <= 1000 ; n++) {while (i<n) { d = n % i
        i += 1
        if (d == 0) {c = c + i
